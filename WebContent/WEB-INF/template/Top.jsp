		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"> 
					<img src='<c:url value="/resources/Images/1.png"/>' alt="로고이미지" style="width:25px;height:25px">
				</a>
			</div>
			<!-- navbar-header -->
				...
				<ul class="nav navbar-nav">
					<li class="dropdown">
			          ...
			          <ul class="dropdown-menu" role="menu">
			            <li><a href="#"><img src='<c:url value="/resources/Images/dog.png"/>' style="width:25px;height:25px"> 강아지</a></li>
			            <li class="divider"></li>
			            <li><a href="#"><img src='<c:url value="/resources/Images/cat.png"/>' style="width:25px;height:25px"> 고양이</a></li>
			            <li class="divider"></li>
			            <li><a href="#"><img src='<c:url value="/resources/Images/reptiles.png"/>' style="width:25px;height:25px"> 파충류 & 양서류</a></li>
			            <li class="divider"></li>
			            <li><a href="#"><img src='<c:url value="/resources/Images/bird.png"/>' style="width:25px;height:25px"> 조류</a></li>
			            <li class="divider"></li>
			            <li><a href="#"><img src='<c:url value="/resources/Images/rat.png"/>' style="width:25px;height:25px"> 기타 포유류</a></li>
			          </ul>
          			</li>
					<li>
					...
					<li>
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="#"><img src='<c:url value="/resources/Images/!.png"/>' style="width:25px;height:25px"> 봤어요</a></li>
							<li class="divider"></li>
							<li><a href="#"><img src='<c:url value="/resources/Images/sad.png"/>' style="width:25px;height:25px"> 찾아요</a></li>
							<li class="divider"></li>
							<li><a href="#">보호소</a></li>
						</ul>
					</li>
