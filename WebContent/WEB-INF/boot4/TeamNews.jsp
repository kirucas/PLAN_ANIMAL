				...
				<div class="carousel-inner ">
					<div class="item active">
						...
						<div class="carousel-caption">
							<h2>애완동물계의 신성!</h2>
							<p>
								새로운 애완동물 올뺴미 코너를 오픈했습니다<br /> 날씬한 몸과 매혹적인 눈<br /> 까딱까딱 귀엽게 움직이는
								올뺴미를 보고싶다면<br /> 이곳으로 오세요!!
							</p>
						</div>
					</div>
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p>
								야심한 밤에 집으로 돌아가는길에 <br /> 검은 고양이를 만났다 <br /> 그런데 집으로 따라가는길에
								계속<br />따라오는 고양이 당신이라면??
							</p>
						</div>
					...
					<div class="item">
						...
						<div class="carousel-caption">
							...
							<p>
								늑대와 개의 다른점을 아시나요? <br /> 개는 언제나 인간의 가장좋은 친구였죠 <br /> 하지만 처음부터
								친구는 아니였습니다 <br /> 거기엔 험난한 과정이 있었습니다
							</p>
						</div>
